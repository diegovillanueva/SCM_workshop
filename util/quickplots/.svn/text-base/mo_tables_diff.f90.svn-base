...
CONTAINS
  ...
  SUBROUTINE init_tables
    ...
    string( 64) = 'SH_VDIFF      W/m2   column heating (vertical diffusion)    ';  factor( 64) =       1.00; offset( 64) =    0.00;
    string( 65) = 'EV_VDIFF      mm/d   column moistening (vertical diffusion) ';  factor( 65) =   86400.00; offset( 65) =    0.00;
    string( 66) = 'CH_CONCLOUD   W/m2   global heat error (convection+cloud)   ';  factor( 66) =       1.00; offset( 66) =    0.00;
    string( 67) = 'CW_CONCLOUD   mm/d   local water error (convection+cloud)   ';  factor( 67) =   86400.00; offset( 67) =    0.00;
    ...
    string( 75) = 'TSICEPDI      C      ice temperature on frozen melt pond  I ';  factor( 75) =       1.00; offset( 75) =    0.00;
    ...
    string( 91) = 'TRFLIAC       W/m2   net LW radiation over ice            IA';  factor( 91) =       1.00; offset( 91) =    0.00;
    string( 92) = 'TRFLWAC       W/m2   net LW radiation over water          WA';  factor( 92) =       1.00; offset( 92) =    0.00;
    string( 93) = 'TRFLLAC       W/m2   net LW radiation over land           LA';  factor( 93) =       1.00; offset( 93) =    0.00;
    string( 94) = 'SOFLIAC       W/m2   net SW radiation over ice            IA';  factor( 94) =       1.00; offset( 94) =    0.00;
    string( 95) = 'SOFLWAC       W/m2   net SW radiation over water          WA';  factor( 95) =       1.00; offset( 95) =    0.00;
    string( 96) = 'SOFLLAC       W/m2   net SW radiation over land           LA';  factor( 96) =       1.00; offset( 96) =    0.00;
    string( 97) = 'FRIAC         %      ice cover (fraction of grid box)       ';  factor( 97) =     100.00; offset( 97) =    0.00;
    ...
    string(102) = 'TSI           C      surface temperature of ice           I ';  factor(102) =       1.00; offset(102) =    0.00;
    string(103) = 'TSW           C      surface temperature of water         W ';  factor(103) =       1.00; offset(103) =    0.00;
    string(104) = 'USTRI         mN/m2  zonal wind stress over ice           I ';  factor(104) =    1000.00; offset(104) =    0.00;
    string(105) = 'VSTRI         mN/m2  meridional wind stress over ice      I ';  factor(105) =    1000.00; offset(105) =    0.00;
    string(106) = 'USTRW         mN/m2  zonal wind stress over water         W ';  factor(106) =    1000.00; offset(106) =    0.00;
    string(107) = 'VSTRW         mN/m2  meridional wind stress over water    W ';  factor(107) =    1000.00; offset(107) =    0.00;
    string(108) = 'USTRL         mN/m2  zonal wind stress over land          L ';  factor(108) =    1000.00; offset(108) =    0.00;
    string(109) = 'VSTRL         mN/m2  meridional wind stress over land     L ';  factor(109) =    1000.00; offset(109) =    0.00;
    string(110) = 'AHFLIAC       W/m2   latent heat flux over ice            IA';  factor(110) =       1.00; offset(110) =    0.00;
    string(111) = 'AHFLWAC       W/m2   latent heat flux over water          WA';  factor(111) =       1.00; offset(111) =    0.00;
    string(112) = 'AHFLLAC       W/m2   latent heat flux over land           LA';  factor(112) =       1.00; offset(112) =    0.00;
    ...
    string(119) = 'AHFSIAC       W/m2   sensible heat flux over ice          IA';  factor(119) =       1.00; offset(119) =    0.00;
    string(120) = 'AHFSWAC       W/m2   sensible heat flux over water        WA';  factor(120) =       1.00; offset(120) =    0.00;
    string(121) = 'AHFSLAC       W/m2   sensible heat flux over land         LA';  factor(121) =       1.00; offset(121) =    0.00;
    ...
    string(130) = 'STP           C      temperature                            ';  factor(130) =       1.00; offset(130) =    0.00;
    ...
    string(139) = 'TSLM1         C      surface temperature of land          L ';  factor(139) =       1.00; offset(139) =    0.00;
    ...
    string(146) = 'AHFS          W/m2   sensible heat flux                     ';  factor(146) =       1.00; offset(146) =    0.00;
    string(147) = 'AHFL          W/m2   latent heat flux                       ';  factor(147) =       1.00; offset(147) =    0.00;
    ...
    string(150) = 'XIVI          g/m2   vertically integrated cloud ice        ';  factor(150) =    1000.00; offset(150) =    0.00;
    string(151) = 'SLP           hPa    mean sea level pressure -1000 hPa      ';  factor(151) =       0.01; offset(151) =    0.00;
    ...
    string(164) = 'ACLCOV        %      total cloud cover                      ';  factor(164) =     100.00; offset(164) =    0.00;
    ...
    string(167) = 'TEMP2         C      2 m temperature                        ';  factor(167) =       1.00; offset(167) =    0.00;
    string(168) = 'DEW2          C      2 m dew-point temperature              ';  factor(168) =       1.00; offset(168) =    0.00;
    string(169) = 'TSURF         C      surface temperature                    ';  factor(169) =       1.00; offset(169) =    0.00;
    ...
    string(175) = 'ALBEDO        %      surface albedo                         ';  factor(175) =     100.00; offset(175) =    0.00;
    string(176) = 'SRADS         W/m2   net surface SW radiation               ';  factor(176) =       1.00; offset(176) =    0.00;
    string(177) = 'TRADS         W/m2   net surface LW radiation               ';  factor(177) =       1.00; offset(177) =    0.00;
    string(178) = 'SRADO         W/m2   net top SW radiation                   ';  factor(178) =       1.00; offset(178) =    0.00;
    string(179) = 'TRADO         W/m2   net top LW radiation  (-OLR)           ';  factor(179) =       1.00; offset(179) =    0.00;
    string(180) = 'USTR          mN/m2  u-stress (all surface types)           ';  factor(180) =    1000.00; offset(180) =    0.00;
    string(181) = 'VSTR          mN/m2  v-stress                               ';  factor(181) =    1000.00; offset(181) =    0.00;
    string(182) = 'EVAP          mm/d   evaporation                            ';  factor(182) =   86400.00; offset(182) =    0.00;
    string(183) = 'XSKEW                skewness of total water amount         ';  factor(183) =       1.00; offset(183) =    0.00;
    string(184) = 'SRAD0D        W/m2   top incoming SW radiation              ';  factor(184) =       1.00; offset(184) =    0.00;
    ...
    string(195) = 'USTRGW        mN/m2  u-gravity wave stress                  ';  factor(195) =    1000.00; offset(195) =    0.00;
    string(196) = 'VSTRGW        mN/m2  v-gravity wave stress                  ';  factor(196) =    1000.00; offset(196) =    0.00;
    string(197) = 'VDISGW        W/m2   gravity wave dissipation               ';  factor(197) =       1.00; offset(197) =    0.00;
    ...
    string(201) = 'T2MAX         C      maximum 2-meter temperature            ';  factor(201) =       1.00; offset(201) =    0.00;
    string(202) = 'T2MIN         C      minimum 2-meter temperature            ';  factor(202) =       1.00; offset(202) =    0.00;
    ...
    string(207) = 'TSOIL         C      deep soil temperature (layer 1)      L ';  factor(207) =       1.00; offset(207) =    0.00;
    ...
    string(211) = 'SICED         m      ice thickness                        I ';  factor(211) =       1.00; offset(211) =    0.00;
    ...
    string(230) = 'QVI           kg/m2  vertically integrated water vapor      ';  factor(230) =       1.00; offset(230) =    0.00;
    string(231) = 'XLVI          g/m2   vertically integrated cloud water      ';  factor(231) =    1000.00; offset(231) =    0.00;
    ...
    string(238) = 'THVSIG        C      stddev virt. pot temp                  ';  factor(238) =       1.00; offset(238) =    0.00;
