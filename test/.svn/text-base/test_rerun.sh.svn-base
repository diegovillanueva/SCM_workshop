...
echo ''
echo '-------------------------------------------------------------------'
echo "Now running test model rev. ${TEST_REVISION} - test case 1: no rerun"
echo '-------------------------------------------------------------------'
...
echo ''
echo '-------------------------------------------------------------------'
echo "Now running test model rev. ${TEST_REVISION} - test case 2: rerun"
echo '-------------------------------------------------------------------'
EXP_REMOVE=true
...
echo '-------------------------------------------------------------------'
echo "Now running test model rev. ${TEST_REVISION} - test case 3: write restart files, lforcererun=.false."
echo '-------------------------------------------------------------------'
${SCR_DIR}/test_echam6_run.sh ${SCR_DIR} test ${TEST_ODIR} 00003rev${TEST_REVISION} ${TEST_MODEL} 17 $NPROCA .false. 11 1 .false.
echo ''
echo '-------------------------------------------------------------------'
echo "Comparison of results for rerun test on revision ${TEST_REVISION}, lforcererun=.false. (no internal rerun)"
echo '-------------------------------------------------------------------'
