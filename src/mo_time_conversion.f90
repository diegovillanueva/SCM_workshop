...
CONTAINS
  ...
  SUBROUTINE p_bcast_time_days (td_struc, p_source, comm)
  USE mo_mpi, ONLY: p_bcast, p_all_comm

  TYPE(time_days),   INTENT(INOUT) :: td_struc
  ...
  CALL p_bcast(td_struc%init,   p_source, p_comm)
  CALL p_bcast(td_struc%day,    p_source, p_comm)
  CALL p_bcast(td_struc%second, p_source, p_comm)

  END SUBROUTINE p_bcast_time_days
