...
MODULE mo_filename
  ...
  PUBLIC :: compose_restart_filename
...
CONTAINS
!------------------------------------------------------------------------------
  SUBROUTINE compose_restart_filename()
    standard_rerun_file='restart_'//TRIM(out_expname)
  END SUBROUTINE compose_restart_filename
